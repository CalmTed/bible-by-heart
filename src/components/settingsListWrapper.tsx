            ...
            >
                {itemSelected && (
                    <View style={{ width: '100%' }}>
                        <View
                            style={settingsListWrapperStyle.minimodalHeaderView}
                        >
                            <IconButton
                                theme={theme}
                                icon={IconName.back}
                            ...
                            />
                            <Text
                                style={{ ...theme.theme.headerText, flex: 1 }}
                            >
                                {(
                                    itemSelected as
                                        | TrainModeModel
                        ...
                        <ScrollView
                            style={
                                settingsListWrapperStyle.minimodalContentsView
                            }
                        >
                            {renderEditItem(
                                itemSelected,
