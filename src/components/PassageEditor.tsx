    ...
    const handleAddresChange = (newAdress: AddressType) => {
        const versesInEnglish = getNumberOfVersesInEnglish(
            ...
            state.passages.map((p) =>
                p.id === tempPassage.id ? tempPassage : p
            )
        );
                ...
                <ScrollView>
                    ...
                    <View style={PEstyle.bodyMeta}>
                        <Text style={PEstyle.bodyMetaText}>
                            {t('DateCreated')}:{' '}
                            {timeToString(tempPassage.dateCreated)}
                        </Text>
                        <Text style={PEstyle.bodyMetaText}>
                            {t('DateEdited')}:{' '}
                            {timeToString(tempPassage.dateEdited)}
                        </Text>
                        <Text style={PEstyle.bodyMetaText}>
                            {tempPassage.dateTested
                                ? t('DateTested') +
                                  ': ' +
                                  timeToString(tempPassage.dateTested)
                                : ''}
                        </Text>
                    </View>
                    <View
