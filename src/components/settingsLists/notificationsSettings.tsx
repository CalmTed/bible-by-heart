        ...
        <View>
            ...
            <SettingsListWrapper
                ...
                handleItemChange={(changedItem) =>
                    setState(
                        (st) =>
                            reduce(st, {
                                name: ActionName.setRemindersList,
                                payload: state.settings.remindersList.map(
                                    (r) =>
                                        r.id === changedItem.id
                ...
                renderListItem={(item, handleChange) => (
                    ...
                    >
                        ...
                        <Text style={theme.theme.text}>
                            {getHumanFriendlyWeeDaysLabel(
                                item as ReminderModel
                            )}
                        </Text>
                    </View>
                )}
                renderEditItem={(item, handleChange, handleRemove) => {
                    ...
                    const hoursSelected = Math.floor(
                        reminderItem.timeInSec / HOUR
                    );
