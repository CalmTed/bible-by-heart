...
const DayActivityBar: FC<{
  ...
  const gradientColors = !!value ? [theme.colors.gradient1, theme.colors.gradient2] : [theme.colors.bgSecond, theme.colors.bgSecond]
  ...
  return <View style={DayActivityBarStyles.dayItemGroup}>
     <LinearGradient
        ...
        <Text style={{...DayActivityBarStyles.itemLabel, ...(isToday ? {color: theme.colors.text} : {})}}>{ label }</Text>
  </View>
}
