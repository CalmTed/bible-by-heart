...
export const ua: typeof en = {
  ...
  SelectTranslationTitle: "Обери переклад",
  StudyOneOfferText: "Вірш додано. Попрактикувати саме його просто зараз?",
  StudyOneOfferConfirm: "Вивчити",
  StudyOneOfferCancel: "Пізніше",
  LevelLabel: "Рівень",
