...
export const en = {
  ...
  SelectTranslationTitle: "Select translation",
  StudyOneOfferText: "Passage added. Practice this one right now?",
  StudyOneOfferConfirm: "Study it",
  StudyOneOfferCancel: "Later",
  LevelLabel: "Level",
  ...
  settsUserRegDate: "Registration date",
  settsUserLastSyncDate: "User data last sync date",
  settsUserGetRemoteUserDataHeader: "Get remote user data",
  settsUserGetRemoteUserDataSubtext: "Fetch data from the server",
  settsUserUserName: "User name",
  settsUserUserTitle: "User title",
  ...
  profilePublicOptionPrivate: "Private",
  dataPublicOptionPublic: "Public anonymized",
  dataPublicOptionPrivate: "Private",
  ...
  newUnknownErrorAuth: "Unknown error with authorization!",
  ...
  netUnauthorized401: "Unauthorized 401",
