        ...
        <View style={{ ...theme.theme.screen, ...theme.theme.view }}>
            <Header
                    ...
                    additionalChildren={[
                      ...
                      />,
                      <Text style={theme.theme.headerText}>{t("loginScreenTitle")}</Text>,
            ...
            <View style={{...theme.theme.view, ...loginStyle.inputView}}>
                ...
                />
                {tempPassword.length > 0 && !isPasswordValid && <Text style={{...loginStyle.passwordRulesLabel,  color: theme.colors.redGradient2}}>{t("passwordRulesLabel")}</Text>}
                <Button 
                    title={t("loginButton")}
                    theme={theme}
                    type="main"
