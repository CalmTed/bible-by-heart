...
import { L40 } from "../../../src/components/levels/Level4";
...
describe("testing level 4 rendering", () => {
  it("Level 4 renders correctly", async () => {
    const testState = {
      ...createAppState(),
      passages: [
        {
    ...
    const test = createTest(123123, 212610751, PASSAGELEVEL.l4);
    const level40Tree = renderWithContext(
      <L40
        test={test}
        state={testState}
        submitTest={() => {}}
    ...
    expect(level40Tree).toMatchSnapshot();
  });
});
