...
describe("testing input", () => {
  ...
  // 8.2.35 — the levels that ask the user to TYPE the passage give the input the
  // whole answer area. `wrapperStyle` reaches the gradient inside the input's own
  // two outer views, so only the component itself can put a flex on them.
