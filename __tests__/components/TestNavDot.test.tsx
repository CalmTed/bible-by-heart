/**
 * The session dot sat off-centre in the test header. The Pressable between the
 * wrapper and the gradient had no size of its own, so the gradient's `height:
 * "100%"` resolved against a view sized by its 13px child: a 13px dot in the
 * top-left corner of an 18px wrapper, and a CURRENT dot — which has no child at
 * all — sized to nothing.
 */
